...
| secondary_substation | normalised_capacity     | normalised_capacity_normalized      | Available demand headroom                                                       |
| traffic_index        | motorized_traffic_index | motorized_traffic_index_normalized  | Observed annual traffic count in road segments, normalised from 0 to 100        |
| existing_evcp        | time_limit              | time_limit_normalized               | Driving distance to nearest existing public EVCP                                |
