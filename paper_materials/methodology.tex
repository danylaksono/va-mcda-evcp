...
\noindent All criterion values are pre-normalised to $[0, 1]$ using min-max normalisation prior to ingestion, ensuring deterministic and reproducible scoring without runtime normalisation cost. Table~\ref{tab:criteria} lists the nine criteria and their data sources.
